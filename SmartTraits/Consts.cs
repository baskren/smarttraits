namespace SmartTraits
{
    public static class Consts
    {
        ...
        public static readonly string[] TraitProcessEnums = { "ProcessOptions", "SmartTraitsDefs.ProcessOptions" };
        public static readonly string[] TraitOptionsEnums = { "TraitOptions", "SmartTraitsDefs.TraitOptions" };
        public static readonly string[] T4TemplateScopeEnums = { "T4TemplateScope", "SmartTraitsDefs.T4TemplateScope" };
        public static readonly string[] ApplyT4Attributes = { "ApplyT4", "ApplyT4Attribute", "SmartTraitsDefs.ApplyT4", "SmartTraitsDefs.ApplyT4Attribute" };
        public static readonly string[] OverrideableAttributes = { "Overrideable", "OverrideableAttribute", "SmartTraitsDefs.Overrideable", "SmartTraitsDefs.OverrideableAttribute" };


        public static readonly string[] IgnoreUsings = { "SmartTraitsDefs" };
